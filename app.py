...
YOLO_BEST_URL = "https://huggingface.co/rupesh9987/aerial-classifier-models/resolve/main/yolo2.pt"
...
def load_models():
    ...
    download_file(YOLO_BEST_URL, "./models/hugging_face/yolo2.pt")

    mobilenet = load_model("./models/hugging_face/mobilenet.keras")
    yolo = YOLO("./models/hugging_face/yolo2.pt")
